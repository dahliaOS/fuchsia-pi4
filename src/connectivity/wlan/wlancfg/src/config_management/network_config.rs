...
fn check_config_errors(
    ...
    // Verify SSID has at most fidl_ieee80211::MAX_SSID_LEN bytes
    if ssid.as_ref().len() > (fidl_ieee80211::MAX_SSID_LEN as usize) {
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> Result<(), fmt::Error> {
        match self {
            ...
            NetworkConfigError::SsidLen => {
                write!(f, "SSID has max allowed length of {}", fidl_ieee80211::MAX_SSID_LEN)
            }
