...
const RegisterInfo kRegisterInfo[] = {
    ...
    {.id = RegisterID::kARMv8_id_aa64dfr0_el1, .name = "id_aa64dfr0", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_id_aa64dfr0_el1, .bits = 64},
    {.id = RegisterID::kARMv8_mdscr_el1,       .name = "mdscr",       .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_mdscr_el1,       .bits = 64},

    {.id = RegisterID::kARMv8_dbgbcr0_el1,  .name = "dbgbcr0",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr0_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr1_el1,  .name = "dbgbcr1",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr1_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr2_el1,  .name = "dbgbcr2",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr2_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr3_el1,  .name = "dbgbcr3",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr3_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr4_el1,  .name = "dbgbcr4",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr4_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr5_el1,  .name = "dbgbcr5",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr5_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr6_el1,  .name = "dbgbcr6",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr6_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr7_el1,  .name = "dbgbcr7",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr7_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr8_el1,  .name = "dbgbcr8",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr8_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr9_el1,  .name = "dbgbcr9",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr9_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr10_el1, .name = "dbgbcr10", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr10_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr11_el1, .name = "dbgbcr11", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr11_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr12_el1, .name = "dbgbcr12", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr12_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr13_el1, .name = "dbgbcr13", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr13_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr14_el1, .name = "dbgbcr14", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr14_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgbcr15_el1, .name = "dbgbcr15", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbcr15_el1, .bits = 32},

    {.id = RegisterID::kARMv8_dbgbvr0_el1,  .name = "dbgbvr0",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr0_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr1_el1,  .name = "dbgbvr1",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr1_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr2_el1,  .name = "dbgbvr2",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr2_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr3_el1,  .name = "dbgbvr3",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr3_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr4_el1,  .name = "dbgbvr4",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr4_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr5_el1,  .name = "dbgbvr5",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr5_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr6_el1,  .name = "dbgbvr6",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr6_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr7_el1,  .name = "dbgbvr7",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr7_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr8_el1,  .name = "dbgbvr8",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr8_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr9_el1,  .name = "dbgbvr9",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr9_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr10_el1, .name = "dbgbvr10", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr10_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr11_el1, .name = "dbgbvr11", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr11_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr12_el1, .name = "dbgbvr12", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr12_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr13_el1, .name = "dbgbvr13", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr13_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr14_el1, .name = "dbgbvr14", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr14_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgbvr15_el1, .name = "dbgbvr15", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgbvr15_el1, .bits = 64},

    {.id = RegisterID::kARMv8_dbgwcr0_el1,  .name = "dbgwcr0",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr0_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr1_el1,  .name = "dbgwcr1",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr1_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr2_el1,  .name = "dbgwcr2",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr2_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr3_el1,  .name = "dbgwcr3",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr3_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr4_el1,  .name = "dbgwcr4",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr4_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr5_el1,  .name = "dbgwcr5",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr5_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr6_el1,  .name = "dbgwcr6",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr6_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr7_el1,  .name = "dbgwcr7",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr7_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr8_el1,  .name = "dbgwcr8",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr8_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr9_el1,  .name = "dbgwcr9",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr9_el1,  .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr10_el1, .name = "dbgwcr10", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr10_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr11_el1, .name = "dbgwcr11", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr11_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr12_el1, .name = "dbgwcr12", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr12_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr13_el1, .name = "dbgwcr13", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr13_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr14_el1, .name = "dbgwcr14", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr14_el1, .bits = 32},
    {.id = RegisterID::kARMv8_dbgwcr15_el1, .name = "dbgwcr15", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwcr15_el1, .bits = 32},

    {.id = RegisterID::kARMv8_dbgwvr0_el1,  .name = "dbgwvr0",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr0_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr1_el1,  .name = "dbgwvr1",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr1_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr2_el1,  .name = "dbgwvr2",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr2_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr3_el1,  .name = "dbgwvr3",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr3_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr4_el1,  .name = "dbgwvr4",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr4_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr5_el1,  .name = "dbgwvr5",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr5_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr6_el1,  .name = "dbgwvr6",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr6_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr7_el1,  .name = "dbgwvr7",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr7_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr8_el1,  .name = "dbgwvr8",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr8_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr9_el1,  .name = "dbgwvr9",  .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr9_el1,  .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr10_el1, .name = "dbgwvr10", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr10_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr11_el1, .name = "dbgwvr11", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr11_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr12_el1, .name = "dbgwvr12", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr12_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr13_el1, .name = "dbgwvr13", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr13_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr14_el1, .name = "dbgwvr14", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr14_el1, .bits = 64},
    {.id = RegisterID::kARMv8_dbgwvr15_el1, .name = "dbgwvr15", .arch = Arch::kArm64, .canonical_id = RegisterID::kARMv8_dbgwvr15_el1, .bits = 64},
